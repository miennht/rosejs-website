...
**Status:** Approved source of truth (`EVAL-P1-003`, `TASK-097`). Expand in `TASK-101`.
...
- Connect technical work to business outcomes (reliability, audit readiness, time-to-market).
- Use specific domains: healthcare insurance, RCM, payer platforms, legacy modernization, integrations.
...
- Use **RoseJS** as the brand; **roseng.org** when referring to the website or email host.
...
- [ ] Sounds credible if read aloud to a skeptical architect
- [ ] No hype-heavy AI claims
- [ ] Aligns with `forbidden-claims.md`
- [ ] Appropriate for healthcare **and** e-commerce contexts when industries are mentioned
