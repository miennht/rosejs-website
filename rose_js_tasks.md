...
- **Production verified:** **[https://www.roseng.org](https://www.roseng.org)** serves the RoseJS MVP (merge-to-`main` deploy on Railway). Optional: enable PR previews in Railway; set **`VITE_SITE_URL=https://www.roseng.org`** on the Railway **build** environment and redeploy.
